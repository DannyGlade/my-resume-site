...
import DashSideLink from "../../parts/admin/DashSideLink";
    ...
    <>
      ...
      <div className="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between flex">
        <div className="px-8">
          ...
          <ul className="mt-12">
            <DashSideLink href="/admin/dashboard" text="Dashboard" />
            <DashSideLink href="/admin/users" text="Users" />
            <DashSideLink href="/admin/posts" text="Posts" />
            <DashSideLink href="/admin/pages" text="Pages" />
            <DashSideLink href="/admin/media" text="Media" />
            <DashSideLink href="/admin/comments" text="Comments" />
            <DashSideLink href="/admin/settings" text="Settings" />
          </ul>
